...
<div class="panel-display panel-frontpage clearfix" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  ...
  <!-- end of front-main-column -->

  <div class="front-first-column">
  ...
  <!-- end of front-first-column  -->

  <div class="front-last-column">
  ...
  <!-- end of front-last-column -->

</div>
<!-- end of panel-frontpage -->
