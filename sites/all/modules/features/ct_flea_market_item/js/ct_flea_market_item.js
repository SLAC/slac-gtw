(function ($) {
  ...
  Drupal.theme.fleaMarketConfirm = function (href, nid) {
    ...
    html += '  <h4 class="report-inappropriate-title">Report Community Post as Inappropriate</h4>';
    html += '  <button class="close top-close">X</button>';
    html += '  <p class="report-message">Flagged ad content will be reviewed by the Office of Communications to determine whether SLAC\'s <a href="https://intranet.slac.stanford.edu/community-bulletin-board">Community Bulliten Board guidelines</a> have been violated.</p>';
