 ...
 *
 * Available variables:
 * - $slac_search_form: The complete search form ready for print.
 * - $search: Associative array of search elements. Can be used to print each
 *   form element separately.
 *
 * Default elements within $search:
 * - $search['slac_search_block_form']: Text input area wrapped in a div.
 ...
 * @endcode
 *
 * @see template_preprocess_slac_search_block_form()
 */
?>
